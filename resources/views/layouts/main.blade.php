        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="/" class="logo">Selamat Datang</a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="/">Home</a></li>
                            ...
                            <li><a data-toggle="modal" data-target="#exampleModal" href="login">Login</a></li>
                        </ul>
                ...
                <div class="modal-body">
                    <form class="modal-content animate" method="post" action="cek.php">
                        <div class="mr-5 ml-5 mb-3 mt-2">
                            <img style=" display: block; margin-left: 20px; margin-right: auto;"
                                src="assets/images/admin.png" alt="Avatar" class="avatar">
